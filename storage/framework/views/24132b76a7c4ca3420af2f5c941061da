...
<div class="container">
    ...
    <div class="reg-block">
        <div class="reg-block-header">
            ...
            <p>Don't Have Account? Click <a class="color-green" href="page_registration1.html">Sign Up</a> to
                registration.</p>
        </div>
        ...
        <div class="col-md-offset-4 col-md-4 col-md-offset-4">
            <button class="btn-u btn-u-red btn-u-lg btn-block pulse-shrink" type="button">Enter Mastahcode</button>
        </div>
