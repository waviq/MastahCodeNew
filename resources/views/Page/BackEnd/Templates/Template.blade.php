@include('Page.BackEnd.Templates.partials.header')
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="{{asset('assets/backend/img/profile_small.jpg')}}" />
                             </span>
...
@include('Page.BackEnd.Templates.partials.script')

@include('Page.BackEnd.Templates.partials.footer')